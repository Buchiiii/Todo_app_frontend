  ...
  return (
    <>
      <div style={{ height: "100vh " }} className=" relative flex flex-col ">
        ...
        <div className="absolute bg-blue-200  flex flex-col  h-80 ">
          <div className="w-[1168px] bg-indigo-900  flex flex-col" >
            
            <div className="flex flex-col justify-center bg-red-200 items-center h-[50%] md:w-40 sm:w-[auto] ">
              <div className="grid bg-blue-200 md:grid-cols-2">
            ...
            {/* //DEMACATION */}
            <div className="   ">
              <div className=" rounded-sm  bg-red-200 shadow-lg z-50 h-60  w-80 sm:w-70 md:w-70 lg:w-60 xl:w-40 2xl:w-40 ">
                <div
                  className={
                    dark
